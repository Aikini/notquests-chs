...
如果你的“点数（Points）”标签（整数标签）大于等于4，这个事件将会被激活，然后给你40块钱。如果没有达到这个要求，将会给你5块钱。如果你想了解标签系统的更多内容，请查阅[标签系统指南](https://www.notquests.com/docs/tutorials/creating-a-reputation-system-with-tags/)。  
